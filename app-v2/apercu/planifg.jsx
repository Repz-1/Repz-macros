...
vueEntrainer.value = { nom: 'planifier', params: { prog: 'seche-6j' } };
...
setInterval(() => {
  ...
  donneesPretes.value = true;
  calculBaseFait.value = true;
  estPremium.value = false;
  if (ongletActif.value !== 'entrainer') ongletActif.value = 'entrainer';
  if (vueEntrainer.value.nom !== 'planifier') vueEntrainer.value = { nom: 'planifier', params: { prog: 'seche-6j' } };
}, 100);
