...
const T = {
  fr: {
    ...
    eat_over: 'Dépasse tes {m} de {n} g — à toi d\u2019ajuster', macro_prot: 'protéines', macro_carbs: 'glucides', macro_lip: 'lipides',
  ...
  en: {
    ...
    eat_over: 'Exceeds your {m} by {n} g — adjust as you like', macro_prot: 'protein', macro_carbs: 'carbs', macro_lip: 'fat',
  ...
  nl: {
    ...
    eat_over: 'Overschrijdt je {m} met {n} g — pas zelf aan', macro_prot: 'eiwitten', macro_carbs: 'koolhydraten', macro_lip: 'vetten',
