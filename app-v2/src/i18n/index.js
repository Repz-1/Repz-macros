...
const T = {
  fr: {
    ...
    eat_over: 'Tu finirais à +{n} g de {m} — à toi d\u2019ajuster', eat_more: 'Afficher {n} autres idées', eat_done: 'Objectif atteint — belle journée. On se retrouve demain.', macro_prot: 'protéines', macro_carbs: 'glucides', macro_lip: 'lipides',
  ...
  en: {
    ...
    eat_over: 'You\u2019d finish at +{n} g {m} — adjust as you like', eat_more: 'Show {n} more ideas', eat_done: 'Target reached — great day. See you tomorrow.', macro_prot: 'protein', macro_carbs: 'carbs', macro_lip: 'fat',
  ...
  nl: {
    ...
    eat_over: 'Je zou eindigen op +{n} g {m} — pas zelf aan', eat_more: 'Toon {n} andere idee\u00ebn', eat_done: 'Doel bereikt — mooie dag. Tot morgen.', macro_prot: 'eiwitten', macro_carbs: 'koolhydraten', macro_lip: 'vetten',
