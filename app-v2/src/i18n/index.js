...
const T = {
  fr: {
    ...
    nav_stats: 'Stats', nav_premium: 'Premium', nav_belfitplus: 'BelFit+', nav_coach: 'Coach',
    ...
    profil_poids: 'Poids',
    profil_recalc: 'Recalculer mes besoins',
    profil_compte: 'Mon compte',
    set_sec_aide: 'Aide',
    abo_sous: 'Formule, paiement, résiliation',
    abo_statut: 'Statut',
    abo_actif: 'Premium actif',
    abo_test: 'Accès complet (période de test)',
    abo_gratuit: 'Gratuit',
    abo_formule: 'Formule',
    abo_canal: 'Paiement',
    abo_canal_web: 'Site web',
    abo_canal_android: 'Google Play',
    abo_canal_ios: 'App Store',
    abo_canal_code: 'Code offert',
    abo_f_mensuel: 'Mensuelle',
    abo_f_trimestriel: 'Trimestrielle',
    abo_f_annuel: 'Annuelle',
    abo_gerer_paiement: 'Gérer mon paiement',
    abo_gerer_paiement_sub: 'Carte, factures, changement de formule',
    abo_voir_offre: 'Voir les formules Premium',
    sortie_titre: 'Se déconnecter ?',
    sortie_texte: 'Ton journal reste sauvegardé sur ton compte. Il sera effacé de ce téléphone jusqu\'à ta prochaine connexion.',
    eat_retour_plus: 'Retour à BelFit+',
    st_train: 'Entraînement',
    st_train_sub: 'Tonnage par semaine, 8 dernières semaines',
    st_train_semaine: 'séances cette semaine',
    st_train_tonnage: 'soulevés cette semaine',
    st_train_vide: 'Aucune séance enregistrée pour l\'instant.',
    st_train_cta: 'Aller m\'entraîner',
    st_avancees: 'Voir les stats avancées',
  ...
  en: {
    ...
    profil_poids: 'Weight',
    profil_recalc: 'Recalculate my needs',
    profil_compte: 'My account',
    set_sec_aide: 'Help',
    abo_sous: 'Plan, payment, cancellation',
    abo_statut: 'Status',
    abo_actif: 'Premium active',
    abo_test: 'Full access (test period)',
    abo_gratuit: 'Free',
    abo_formule: 'Plan',
    abo_canal: 'Payment',
    abo_canal_web: 'Website',
    abo_canal_android: 'Google Play',
    abo_canal_ios: 'App Store',
    abo_canal_code: 'Gift code',
    abo_f_mensuel: 'Monthly',
    abo_f_trimestriel: 'Quarterly',
    abo_f_annuel: 'Yearly',
    abo_gerer_paiement: 'Manage my payment',
    abo_gerer_paiement_sub: 'Card, invoices, change plan',
    abo_voir_offre: 'See Premium plans',
    sortie_titre: 'Log out?',
    sortie_texte: 'Your journal stays saved on your account. It will be removed from this phone until you log in again.',
    eat_retour_plus: 'Back to BelFit+',
    st_train: 'Training',
    st_train_sub: 'Weekly volume, last 8 weeks',
    st_train_semaine: 'sessions this week',
    st_train_tonnage: 'lifted this week',
    st_train_vide: 'No session logged yet.',
    st_train_cta: 'Go train',
    st_avancees: 'See advanced stats',
  ...
  nl: {
    ...
    profil_poids: 'Gewicht',
    profil_recalc: 'Mijn behoeften herberekenen',
    profil_compte: 'Mijn account',
    set_sec_aide: 'Hulp',
    abo_sous: 'Formule, betaling, opzeggen',
    abo_statut: 'Status',
    abo_actif: 'Premium actief',
    abo_test: 'Volledige toegang (testperiode)',
    abo_gratuit: 'Gratis',
    abo_formule: 'Formule',
    abo_canal: 'Betaling',
    abo_canal_web: 'Website',
    abo_canal_android: 'Google Play',
    abo_canal_ios: 'App Store',
    abo_canal_code: 'Cadeaucode',
    abo_f_mensuel: 'Maandelijks',
    abo_f_trimestriel: 'Per kwartaal',
    abo_f_annuel: 'Jaarlijks',
    abo_gerer_paiement: 'Mijn betaling beheren',
    abo_gerer_paiement_sub: 'Kaart, facturen, formule wijzigen',
    abo_voir_offre: 'Premium-formules bekijken',
    sortie_titre: 'Afmelden?',
    sortie_texte: 'Je dagboek blijft bewaard op je account. Het wordt van deze telefoon gewist tot je opnieuw inlogt.',
    eat_retour_plus: 'Terug naar BelFit+',
    st_train: 'Training',
    st_train_sub: 'Volume per week, laatste 8 weken',
    st_train_semaine: 'sessies deze week',
    st_train_tonnage: 'getild deze week',
    st_train_vide: 'Nog geen sessie geregistreerd.',
    st_train_cta: 'Gaan trainen',
    st_avancees: 'Geavanceerde stats bekijken',
