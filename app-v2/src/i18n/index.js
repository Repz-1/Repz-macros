...
const T = {
  fr: {
    ...
    eat_limited: 'Portion limitée par tes {m}', macro_prot: 'protéines', macro_carbs: 'glucides', macro_lip: 'lipides',
  ...
  en: {
    ...
    eat_limited: 'Portion limited by your {m}', macro_prot: 'protein', macro_carbs: 'carbs', macro_lip: 'fat',
  ...
  nl: {
    ...
    eat_limited: 'Portie beperkt door je {m}', macro_prot: 'eiwitten', macro_carbs: 'koolhydraten', macro_lip: 'vetten',
